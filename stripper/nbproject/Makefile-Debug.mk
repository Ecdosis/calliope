...
${OBJECTDIR}/src/hh_exceptions.o: src/hh_exceptions.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -DCOMMANDLINE -DHAVE_EXPAT_CONFIG_H -DHAVE_MEMMOVE -DMEMWATCH -Iinclude -I../formatter/include/STIL -I../formatter/include -I/System/Library/Frameworks/JavaVM.framework/Versions/Current/Headers -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/hh_exceptions.o src/hh_exceptions.c
