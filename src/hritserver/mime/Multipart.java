...
public class Multipart 
{
     ...
     */
    void setBoundary( String multipart, int first ) throws HritException
    {
        ...
        if ( bEnd != -1 )
            ...
            throw new HritException("expected CRLF at boundary end");
    }
    /**
     ...
     */
    public Part getPart( int index ) throws HritException
    {
        if ( index <= parts.size() )
            return parts.get( index );
        else
            throw new HritException("invalid index "+index+"+ (max="
                +parts.size()+")");
    }
    /**
     ...
     */
    public static Multipart internalise( String multipart ) throws HritException
    {
